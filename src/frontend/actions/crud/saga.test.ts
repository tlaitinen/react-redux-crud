...
const actions = actionsApi.create<'dummy', Dummy, Query, DummyIn>('dummy');
const sagas1 = saga.create<'dummy', Dummy, Query, RootState, DummyIn>({
  crud:'dummy',
  getId,
  getState,
  entitiesQuery,
...
const sagas2 = saga.create<'dummy', Dummy, Query, RootState, DummyIn>({
  crud:'dummy',
  getId,
  getState,
  entitiesQuery,
...
const sagas3 = saga.create<'dummy', Dummy, Query, RootState, DummyIn>({
  crud:'dummy',
  getId,
  getState,
  entitiesQuery,
